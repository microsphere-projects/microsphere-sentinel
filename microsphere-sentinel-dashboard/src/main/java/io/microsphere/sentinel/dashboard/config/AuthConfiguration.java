...
import io.microsphere.sentinel.dashboard.auth.AuthorizationInterceptor;
import io.microsphere.sentinel.dashboard.auth.DefaultAuthorizationInterceptor;
import io.microsphere.sentinel.dashboard.auth.DefaultLoginAuthenticationFilter;
import io.microsphere.sentinel.dashboard.auth.FakeAuthServiceImpl;
import io.microsphere.sentinel.dashboard.auth.LoginAuthenticationFilter;
