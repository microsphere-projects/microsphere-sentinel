...
import io.microsphere.sentinel.dashboard.datasource.entity.gateway.ApiPredicateItemEntity;
import io.microsphere.sentinel.dashboard.discovery.MachineInfo;
import io.microsphere.sentinel.dashboard.domain.Result;
import io.microsphere.sentinel.dashboard.domain.vo.gateway.api.AddApiReqVo;
import io.microsphere.sentinel.dashboard.domain.vo.gateway.api.ApiPredicateItemVo;
import io.microsphere.sentinel.dashboard.domain.vo.gateway.api.UpdateApiReqVo;
import io.microsphere.sentinel.dashboard.repository.gateway.InMemApiDefinitionStore;
